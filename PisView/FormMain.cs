...
namespace View
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Програма была разработана для автоматизации жилищного кооператива. Данный модуль поможет автоматизировать деятельнось пасспортиста. Данную программу сделал студент гр. ИСЭ-31.", "Сообщение",
